...
def main(argv=None):
    ...
    file = codecs.open(filespec, 'r', encoding='utf-8')
    ...
    fout = open(os.path.join(script_dir, "toc-out.txt"), "w",encoding="utf-8")
    for r in results:
        header_level = r[0]
        spaces = "  " * (header_level - min_header_level)
        fout.write("{}{} [{}]({})".format(spaces, TOC_LIST_PREFIX, r[1], r[2]) + '\n')
    fout.close()
